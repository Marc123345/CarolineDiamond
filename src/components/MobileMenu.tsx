...
import {
  ...
  User, MapPin, Palette, HandHeart, Gem, ChevronRight,
        ...
        >
          ...
          <header className="relative z-10 p-8 flex items-center justify-between border-b border-black/[0.03]">
            <motion.div variants={itemVars}>
              ...
              <p className="text-[10px] uppercase tracking-[0.4em] text-Color-Light-300 font-black mt-1">Navigation Menu</p>
            </motion.div>
            <button 
              onClick={() => setShowMenu(false)}
          ...
          >
            <div className="bg-white p-6 shadow-xl flex items-center gap-6 rounded-sm border border-black/5">
              ...
              <div>
                ...
                <p className="text-[11px] text-Color-Gray-500 italic mt-1">Handcrafted with precision since 2009.</p>
                <div className="flex gap-4 mt-3 opacity-40">
                  <span className="text-[9px] uppercase font-bold tracking-tighter">15Y Excellence</span>
                  <span className="text-[9px] uppercase font-bold tracking-tighter">HRD Certified</span>
                </div>
              </div>
            </div>
          </motion.footer>
