...
// Helper to map generic GraphQL metafields array to your typed object
const mapMetafields = (edges: any[]): ProductMetafields => {
  ...
  edges.forEach(mf => {
    ...
    // Map specific keys to your interface properties
    switch(mf.key) {
...
// Helper to transform a single Shopify product node into ProcessedProduct
