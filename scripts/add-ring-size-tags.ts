...
async function main() {
  console.log('🔧 Adding ring size availability tags...\n');
  console.log('================================================================================\n');
  ...
  try {
    ...
    for (const product of engagementRings) {
      ...
      const missingTags = ringSizeTags.filter((tag) => !currentTags.includes(tag));
    ...
    console.log('Summary:');
    console.log(`  ✅ Added ring size availability tags to all engagement rings`);
    console.log(`  ✅ Sizes added: 48, 52, 54, 58, 60`);
    console.log('\n🎉 Ring Size filter will now work correctly!\n');
  } catch (error) {
